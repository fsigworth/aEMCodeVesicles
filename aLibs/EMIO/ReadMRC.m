...
if halfPrecision % convert uint16 to half-precision float. Simple typecast() doesn't work.
    map=half.typecast(map); % This is the trick described Krishna B. in this note:
 %  https://www.mathworks.com/matlabcentral/answers/520544-how-to-convert-half-precision-number-into-hexadecimal-representation
end;
