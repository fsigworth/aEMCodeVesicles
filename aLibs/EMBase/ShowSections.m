...
for iSlice=1:nim
    ...
    if showRowLabels
        ...
        text(0,0.5,options.rowLabels{iSlice},'Units','normalized','rotation',90,...
    ...
    if ~isStack
        %         rotMap=abs(rotMap);
        subplot2(3,3,7);  % Plot 1D sections along x, y and z
        ...
        subplot2(3,3,8);  % Plot corresponding 1D projections
